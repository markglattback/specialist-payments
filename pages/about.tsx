      ...
      <Wrapper>
        <article>
          <div className="about-us">
            <h1>About Us</h1>
            <p>
              Specialist Payments was launched with an ambition to make payment
              solutions more cost effective and fairer. Card payments have been
              increasing for many years, however, on the back of Covid-19 , the
              world is experiencing a massive shift, and so is the way
              businesses take payments. Whilst cash will still be around for
              years to come, the demand for contactless payments is almost an
              expectation for most customers these days, and even more so with
              social distancing playing a role.
            </p>
            <p>
              That's where we come in. Whether you already have a payment
              solution in place, or you are looking to acquire one, we can help
              you. We want to help our clients grow their business by
